...
class WxPayDataBase
{
	...
	**/
     ...
     * @param string $value
     **/
    public function SetSign_cash($config)
    {
        $sign = $this->MakeSign_cash($config);
        $this->values['sign'] = $sign;
        return $sign;
    }
	...
	**/
     ...
     * @return $result
     */
    public function MakeSign_cash($config)
    {
 ...
 *
 */
class WxPayTransfersOrder extends WxPayDataBase
{
    /**
     * 设置微信分配的公众账号ID
     * @param string $value
 ...
 *
 */
class WxPayProfit extends WxPayDataBase
{
    /**
     * 设置微信分配的公众账号ID
     * @param string $value
     ...
     * @param string $value
     **/
    public function SetProfitType($value)
    {
     ...
     * @param string $value
     **/
    public function SetReturnAccountType($value)
    {
        $this->values['return_account_type'] = $value;
    }
    ...
    {
        $this->values['return_account'] = $value;
    }
    ...
    {
        $this->values['return_amount'] = $value;
    }
    ...
    {
        $this->values['out_return_no'] = $value;
    }
 ...
 *
 */
class WxPayContract extends WxPayDataBase
{
    /**
     * 设置微信分配的公众账号ID
     * @param string $value
    ...
    //签约商户号
    public function SetContract_mchid($value)
    {
        $this->values['contract_mchid'] = $value;
    }

    //签约商户号
    public function getContractMchid()
    {
        $this->values['contract_mchid'];
    }

    //签约appid
    public function SetContract_appid($value)
    {
        $this->values['contract_appid'] = $value;
    }

    public function getContractAppid()
    {
        $this->values['contract_appid'];
    }
    ...
    //签约协议号
    public function SetContract_code($value)
    {
        $this->values['contract_code'] = $value;
    }

    public function getContractcode()
    {
        $this->values['contract_code'];
    }

    //签约协议号
    public function SetContract_notify_url($value)
    {
        $this->values['contract_notify_url'] = $value;
    }

    public function getContractnotifyurl()
    {
        $this->values['contract_notify_url'];
    }

    //请求序列号
    public function SetRequest_serial($value)
    {
        $this->values['request_serial'] = $value;
    }

    public function getRequestSerial()
    {
        $this->values['request_serial'];
    }

    //用户账户展示名称
    public function SetContract_display_account($value)
    {
        $this->values['contract_display_account'] = $value;
    }

    public function getContractDisplayAccount()
    {
        $this->values['contract_display_account'];
    }
